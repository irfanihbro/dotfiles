...
local primary_browser = "zen-browser"
...
local function toggle_layout()
  ...
  hl.exec_cmd("notify-send 'Hyprland' 'Layout: " .. current_layout .. "'")
end

hl.bind(mainMod .. " + X", toggle_layout, { repeating = false })
...
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd("pid=$(hyprctl activewindow -j | jq '.pid'); kill $pid; sleep 0.5; kill -9 $pid 2>/dev/null"))
